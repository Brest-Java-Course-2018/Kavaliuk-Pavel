...
public class DepartmentDaoImpl implements DepartmentDao {
    ...
    private final String GET_DEPARTMENTS_BY_ID = "SELECT departmentId,"
            + " departmentName, description FROM department WHERE departmentId = :departmentId";
    ...
    public Department getDepartmentById(Integer departmentId) {
        ...
        Department department = namedParameterJdbcTemplate.queryForObject(GET_DEPARTMENTS_BY_ID, sqlParameterSource, new DepartmentRowMapper());
