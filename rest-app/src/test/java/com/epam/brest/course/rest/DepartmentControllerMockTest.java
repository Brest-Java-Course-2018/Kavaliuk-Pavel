...
public class DepartmentControllerMockTest {
    ...
    public void setUp() {
        ...
        departmentDTO1.setDepartmentName("name 1");

        departmentDTO2.setDepartmentId(2);
        departmentDTO2.setDepartmentName("name 2");
    ...
    public void getDepartments() throws Exception {
        ...
        mockMvc.perform(get("/departments")
                ...
                .andExpect(jsonPath("$[0].departmentName", is("name 1")))
                .andExpect(jsonPath("$[1].departmentId", is(2)))
                .andExpect(jsonPath("$[1].departmentName", is("name 2")));
    }
